Public Class PFMs
    ...
    Public HCenterlining = libro.Worksheets("PFMS")
...
#Region "Envio de Datos"
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If (TextBox1.Text = "" Or TextBox2.Text = "" Or TextBox3.Text = "" Or TextBox4.Text = "" Or TextBox5.Text = "" Or
            ...
            TextBox36.Text = "" Or TextBox37.Text = "" Or CBTurno.Text = "" Or CBSupervisor.Text = "" Or
        ...
        Else
            ...
            For Each oControl As Control In Me.PanelVariables.Controls
                ...
                If TypeOf oControl Is TextBox Then
                    ...
                    textb += 1
                    VariablesPMFS = CType(oControl, TextBox).Text

#Region "label PMFS"
                    If textb = 1 Then
                        LabelPMFS = LabelTitulo.Text
                    End If
                    If textb = 2 Then
                        LabelPMFS = LabelX.Text
                    End If
                    If textb = 3 Then
                        LabelPMFS = LabelReferencia.Text
                    End If
                    If textb = 4 Then
                        LabelPMFS = Label1.Text
                    End If
                    If textb = 5 Then
                        LabelPMFS = Label2.Text
                    End If
                    If textb = 6 Then
                        LabelPMFS = Label3.Text
                    End If
                    If textb = 7 Then
                        LabelPMFS = Label4.Text
                    End If
                    If textb = 8 Then
                        LabelPMFS = Label5.Text
                    End If
                    If textb = 9 Then
                        LabelPMFS = Label6.Text
                    End If
                    If textb = 10 Then
                        LabelPMFS = Label7.Text
                    End If
                    If textb = 11 Then
                        LabelPMFS = Label8.Text
                    End If
                    If textb = 12 Then
                        LabelPMFS = Label9.Text
                    End If
                    If textb = 13 Then
                        LabelPMFS = Label10.Text
                    End If
                    If textb = 14 Then
                        LabelPMFS = Label11.Text
                    End If
                    If textb = 15 Then
                        LabelPMFS = Label12.Text
                    End If
                    If textb = 16 Then
                        LabelPMFS = Label13.Text
                    End If
                    If textb = 17 Then
                        LabelPMFS = Label14.Text
                    End If
                    If textb = 18 Then
                        LabelPMFS = Label15.Text
                    End If
                    If textb = 19 Then
                        LabelPMFS = Label16.Text
                    End If
                    If textb = 20 Then
                        LabelPMFS = Label17.Text
                    End If
                    If textb = 21 Then
                        LabelPMFS = Label34.Text
                    End If
                    If textb = 22 Then
                        LabelPMFS = Label33.Text
                    End If
                    If textb = 23 Then
                        LabelPMFS = Label32.Text
                    End If
                    If textb = 24 Then
                        LabelPMFS = Label31.Text
                    End If
                    If textb = 25 Then
                        LabelPMFS = Label30.Text
                    End If
                    If textb = 26 Then
                        LabelPMFS = Label29.Text
                    End If
                    If textb = 27 Then
                        LabelPMFS = Label28.Text
                    End If
                    If textb = 28 Then
                        LabelPMFS = Label27.Text
                    End If
                    If textb = 29 Then
                        LabelPMFS = Label26.Text
                    End If
                    If textb = 30 Then
                        LabelPMFS = Label25.Text
                    End If
                    If textb = 31 Then
                        LabelPMFS = Label24.Text
                    End If
                    If textb = 33 Then
                        LabelPMFS = Label22.Text
                    End If
                    If textb = 33 Then
                        LabelPMFS = Label22.Text
                    End If
                    If textb = 34 Then
                        LabelPMFS = Label21.Text
                    End If
                    If textb = 35 Then
                        LabelPMFS = Label20.Text
                    End If
                    If textb = 36 Then
                        LabelPMFS = Label19.Text
                    End If
                    If textb = 37 Then
                        LabelPMFS = Label18.Text
                    End If
#End Region
                    ...
                    HCenterlining.Cells(Final, Ucolumna - textb) = Convert.ToDecimal(VariablesPMFS)

                    ' Examina las variables si se encuentran dentro de los limites 
                    If Convert.ToDecimal(VariablesPMFS) < LIC Or Convert.ToDecimal(VariablesPMFS) > LSC Then

                        contadorVariablesFuera += 1

                        'Envio de Comentarios
                        Dim descripcion As String
                        descripcion = InputBox("Descripcion de Evento " & LabelPMFS & ": " & VariablesPMFS, "Variables Fuera de Rango : # " & contadorVariablesFuera)

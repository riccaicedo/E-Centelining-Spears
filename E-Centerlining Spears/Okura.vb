Public Class Okura
    ...
    Public HCenterlining = libro.Worksheets("OKURA")
...
#Region "Envio de Datos"
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If (TextBox1.Text = "" Or TextBox2.Text = "" Or TextBox3.Text = "" Or TextBox4.Text = "" Or TextBox5.Text = "" Or
            ...
            TextBox31.Text = "" Or TextBox32.Text = "" Or TextBox33.Text = "" Or TextBox34.Text = "" Or TextBox36.Text = "" Or
            CBTurno.Text = "" Or CBSupervisor.Text = "" Or CBOperario.Text = "" Or CBReferencia.Text = "") Or
            ...
            TextBox21.Text = "-" Or TextBox22.Text = "-" Or TextBox23.Text = "-" Or TextBox24.Text = "-" Or TextBox25.Text = "-" Or
            TextBox26.Text = "-" Or TextBox27.Text = "-" Or TextBox28.Text = "-" Or TextBox29.Text = "-" Or TextBox30.Text = "-" Or
            TextBox31.Text = "-" Or TextBox32.Text = "-" Or TextBox33.Text = "-" Or TextBox34.Text = "-" Or TextBox36.Text = "-" Or CBTurno.Text = "-" Or CBSupervisor.Text = "-" Or
        ...
        Else
            ...
            For Each oControl As Control In Me.PanelVariables.Controls
                ...
                If TypeOf oControl Is TextBox Then
                    ...
                    textb += 1
                    VariablesOkura = CType(oControl, TextBox).Text

#Region "label Okura"
                    If textb = 1 Then
                        LabelOkura = Label36.Text
                    End If
                    If textb = 2 Then
                        LabelOkura = Label35.Text
                    End If
                    If textb = 3 Then
                        LabelOkura = Label34.Text
                    End If
                    If textb = 4 Then
                        LabelOkura = Label33.Text
                    End If
                    If textb = 5 Then
                        LabelOkura = Label32.Text
                    End If
                    If textb = 6 Then
                        LabelOkura = Label31.Text
                    End If
                    If textb = 7 Then
                        LabelOkura = Label30.Text
                    End If
                    If textb = 8 Then
                        LabelOkura = Label29.Text
                    End If
                    If textb = 9 Then
                        LabelOkura = Label28.Text
                    End If
                    If textb = 10 Then
                        LabelOkura = Label27.Text
                    End If
                    If textb = 11 Then
                        LabelOkura = Label26.Text
                    End If
                    If textb = 12 Then
                        LabelOkura = Label25.Text
                    End If
                    If textb = 13 Then
                        LabelOkura = Label24.Text
                    End If
                    If textb = 14 Then
                        LabelOkura = Label23.Text
                    End If
                    If textb = 15 Then
                        LabelOkura = Label22.Text
                    End If
                    If textb = 16 Then
                        LabelOkura = Label21.Text
                    End If
                    If textb = 17 Then
                        LabelOkura = Label20.Text
                    End If
                    If textb = 18 Then
                        LabelOkura = Label19.Text
                    End If
                    If textb = 19 Then
                        LabelOkura = Label18.Text
                    End If
                    If textb = 20 Then
                        LabelOkura = Label17.Text
                    End If
                    If textb = 21 Then
                        LabelOkura = Label16.Text
                    End If
                    If textb = 22 Then
                        LabelOkura = Label15.Text
                    End If
                    If textb = 23 Then
                        LabelOkura = Label14.Text
                    End If
                    If textb = 24 Then
                        LabelOkura = Label13.Text
                    End If
                    If textb = 25 Then
                        LabelOkura = Label12.Text
                    End If
                    If textb = 26 Then
                        LabelOkura = Label11.Text
                    End If
                    If textb = 27 Then
                        LabelOkura = Label10.Text
                    End If
                    If textb = 28 Then
                        LabelOkura = Label9.Text
                    End If
                    If textb = 29 Then
                        LabelOkura = Label8.Text
                    End If
                    If textb = 30 Then
                        LabelOkura = Label7.Text
                    End If
                    If textb = 31 Then
                        LabelOkura = Label6.Text
                    End If
                    If textb = 32 Then
                        LabelOkura = Label5.Text
                    End If
                    If textb = 33 Then
                        LabelOkura = Label4.Text
                    End If
                    If textb = 34 Then
                        LabelOkura = Label3.Text
                    End If
                    If textb = 35 Then
                        LabelOkura = Label2.Text
                    End If
                    If textb = 36 Then
                        LabelOkura = Label1.Text
                    End If
#End Region
                    ...
                    If Convert.ToDecimal(VariablesOkura) = 0 Then
                        HCenterlining.cells(Final, Ucolumna - textb) = "*"
                    Else
                        ' Inserta las variables
                        HCenterlining.Cells(Final, Ucolumna - textb) = Convert.ToDecimal(VariablesOkura)
                    End If
                    ...
                    If Convert.ToDecimal(VariablesOkura) <> 0 Then
                        ...
                        If Convert.ToDecimal(VariablesOkura) < LIC Or Convert.ToDecimal(VariablesOkura) > LSC Then

                            contadorVariablesFuera += 1

                            'Envio de Comentarios
                            Dim descripcion As String
                            descripcion = InputBox("Descripcion de Evento " & LabelOkura & ": " & VariablesOkura, "Variables Fuera de Rango : # " & contadorVariablesFuera)
